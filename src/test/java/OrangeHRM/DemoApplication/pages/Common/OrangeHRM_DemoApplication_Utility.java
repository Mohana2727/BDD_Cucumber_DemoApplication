...
public class OrangeHRM_DemoApplication_Utility {
	...
	public OrangeHRM_DemoApplication_Utility(OrangeHRM_DemoApplication_SharedResources newToursResources) throws IOException
	{
		this.driver = newToursResources.getDriver();
		ReadProperties();
	}
	...
	{
		pf = new Properties();
		FileInputStream f1 = new FileInputStream(System.getProperty("user.dir") +"\\Resources\\OrangeHRM_DemoApplication.properties");
		pf.load(f1);
	}
	// ====================================================================================
